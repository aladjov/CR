...
class TestBronzeAggregationOverrides:
    ...
    def test_windows_override_replaces_aggregation_windows(self, sample_findings_dir):
        parser = FindingsParser(
            str(sample_findings_dir),
            bronze_aggregation_overrides={
        ...
        assert orders_cfg.aggregation.windows == ["7d", "30d", "all_time"]
    ...
    def test_combined_overrides(self, sample_findings_dir):
        ...
        assert cfg.aggregation.windows == ["30d", "all_time"]
