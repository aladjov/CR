...
def full_findings_setup(tmp_path):
    ...
    recommendations = {
        ...
        "silver": {
            ...
            "derived_columns": [
                {"id": "silver_ratio", "layer": "silver", "category": "derived", "action": "ratio",
                 "target_column": "age_to_amount_ratio",
                 "parameters": {"feature_type": "ratio", "numerator": "age", "denominator": "amount",
                                "expression": "age / amount"},
                ...
                {"id": "silver_interaction", "layer": "silver", "category": "derived", "action": "interaction",
                 "target_column": "age_x_amount",
                 "parameters": {"feature_type": "interaction", "features": ["age", "amount"],
                                "expression": "age * amount"},
        ...
        "gold": {
            ...
            "transformations": [
                {"id": "gold_transform_amount", "layer": "gold", "category": "transformation",
                 "action": "cap_then_log", "target_column": "amount",
